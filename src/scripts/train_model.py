...
class ModelTrainer:
    ...
    def load_config(self, config_path: str = None) -> dict:
        ...
        if config_path is None:
            config_path = (
                Path(__file__).parent.parent.parent / "config" / "train_config.yaml"
            )
    ...
    def get_default_config(self) -> dict:
        ...
        return {
            "model": {"architecture": "yolov8l", "input_size": 640, "pretrained": True},
            "training": {
                "epochs": 300,
                "batch_size": 16,
                "learning_rate": 0.01,
    ...
    def prepare_datasets(self) -> str:
        ...
        try:
            ...
            if unified_config_path.exists():
                ...
                logger.error(
                    "Unified dataset not found. Please run dataset_unifier.py first."
                )
    ...
    def train(
        self, data_config_path: str = None, resume: bool = False, use_wandb: bool = True
    ) -> str:
        """
        Train the model.
    ...
    def export_model(
        self, model_path: str, export_formats: list = ["onnx", "engine"]
    ) -> dict:
        """
...
def main():
    ...
    parser.add_argument(
        "--benchmark", action="store_true", help="Benchmark model after training"
    )
    ...
    try:
        ...
        best_model_path = trainer.train(
            data_config_path=args.data, resume=args.resume, use_wandb=not args.no_wandb
        )
