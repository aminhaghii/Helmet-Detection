...
class InferenceEngine:
    ...
    def _load_model(self):
        ...
        try:
            ...
            if Path(self.model_path).exists():
                ...
                logger.warning(f"Model file not found: {self.model_path}, loading pretrained")
    ...
    def predict_single(self, 
                      ...
                      iou_threshold: float = 0.45) -> Tuple[List[Dict], float]:
        """
    ...
    def benchmark(self, 
                  num_frames: int = 100,
                  image_size: Tuple[int, int] = (640, 480)) -> Dict:
        """
