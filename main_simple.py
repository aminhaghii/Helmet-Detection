...
class SimpleDetectionApp:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="HSE Vision - Safety Detection System", 
                               font=("Arial", 16, "bold"))
        ...
        self.test_button = ttk.Button(control_frame, text="Test System", 
        ...
        ttk.Label(stats_frame, text="Total Detections:").grid(row=0, column=0, sticky=tk.W)
        ...
        self.helmet_label = ttk.Label(stats_frame, text="0", font=("Arial", 12, "bold"), 
                                     foreground="green")
        self.helmet_label.grid(row=1, column=1, sticky=tk.W, padx=(10, 0))
        
        ttk.Label(stats_frame, text="Without Helmet:").grid(row=2, column=0, sticky=tk.W)
        self.no_helmet_label = ttk.Label(stats_frame, text="0", font=("Arial", 12, "bold"), 
                                        foreground="red")
    ...
    def detection_loop(self):
        ...
        while self.is_running:
            ...
            if self.is_running:  # Check again in case stopped during sleep
                ...
                self.root.after(0, self.update_detection_ui, detection_type, confidence, color)
    ...
    def test_system(self):
        ...
        config_files = ["config/data.yaml", "config/model_config.yaml", "config/deployment_config.yaml"]
